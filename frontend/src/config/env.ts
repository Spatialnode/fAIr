...
export const ENVS = {
  ...
  MAXIMUM_ORTHO_SKEW_TOLEARANCE_AND_MAX_ANGLE_CHANGE_IN_DEGREES: import.meta.env
    .VITE_MAXIMUM_ORTHO_SKEW_TOLEARANCE_AND_MAX_ANGLE_CHANGE_IN_DEGREES,

  PREDICTIONS_RESULTS_POINT_FILL_COLOR: import.meta.env
    .VITE_PREDICTIONS_RESULTS_POINT_FILL_COLOR,
  PREDICTIONS_RESULTS_POINT_OUTLINE_COLOR: import.meta.env
    .VITE_PREDICTIONS_RESULTS_POINT_OUTLINE_COLOR,

  FAIR_YOUTUBE_UPDATES_URL: import.meta.env.FAIR_VIDEO_UPDATES_URL,
  FAIR_VIDEO_BACKUP_URL: import.meta.env.FAIR_VIDEO_BACKUP_URL,
