...
import { BotIcon, FeedbackIcon, PeopleIcon, ProductionCheckmarkIcon } from "@/components/ui/icons";
      ...
      {KPIs.map((kpi, id) => (
        <div className={`flex gap-x-3 items-center h-24 w-48`} key={`kpi-${id}`}>
          ...
          <div className="flex flex-col items-start">
            <h1 className={`text-title-2 font-bold text-primary ${!data ? "animate-pulse" : ""}`}>
